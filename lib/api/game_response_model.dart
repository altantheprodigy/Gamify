...
//
//     final gameResponseModel = gameResponseModelFromJson(jsonString);

import 'dart:convert';

GameResponseModel gameResponseModelFromJson(String str) => GameResponseModel.fromJson(json.decode(str));

String gameResponseModelToJson(GameResponseModel data) => json.encode(data.toJson());
...
class GameResponseModel {
  ...
  factory GameResponseModel.fromJson(Map<String, dynamic> json) => GameResponseModel(
    count: json["count"],
    next: json["next"],
